...
$env:AGENT_MATLAB_ROLE = 'codex'
$env:AGENT_MATLAB_MCP_APPDATA = 'C:\Users\ADMIN\AppData\Roaming\MATLABMCP-Codex'
...
Write-Host ''
Write-Host '=== CODEX MATLAB MCP GUI launcher ==='
Write-Host 'This MATLAB GUI is reserved for Codex MCP attach.'
Write-Host 'MATLAB Command Window should show: MATLAB MCP session for CODEX.'
Write-Host 'MCP session root: C:\Users\ADMIN\AppData\Roaming\MATLABMCP-Codex'
Write-Host 'COMSOL LiveLink bootstrap: enabled'
Write-Host 'COMSOL target server: 127.0.0.1:2036'
Write-Host 'Do not attach Claude to this MATLAB GUI.'
Write-Host ''
