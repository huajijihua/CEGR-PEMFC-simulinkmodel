...
study.hotStartPolicy = cfg.hotStartPolicy;
study.initialStateFile = string(cfg.initialStateFile);
...
function cfg = normalizeStudyConfig(user, modelDir)
cfg = struct( ...
...
cfg.hotStartPolicy = lower(string(cfg.hotStartPolicy));
if ~isscalar(cfg.hotStartPolicy) || ...
        ~any(cfg.hotStartPolicy == ["auto", "hot", "cold"])
...
for idx = 1:numel(cases)
    ...
    plans(idx).initialState = struct( ...
        ...
        'policy', string(context.hotStartPolicy), ...
        'usedOperatingPoint', context.initialStateSelection.useOperatingPoint, ...
        'selectionReason', string(context.initialStateSelection.reason), ...
        'mismatches', context.initialStateSelection.mismatches, ...
        'file', context.initialStateFile, ...
