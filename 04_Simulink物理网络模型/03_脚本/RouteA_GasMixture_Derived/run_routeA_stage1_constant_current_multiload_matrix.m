...
% case uses one common saved formal mode-1 operating point, a fixed 600 s logical
...
%
% studyCfg accepts runPreflight (default true) and protocol overrides. The
% cEGR valve maximum area is read directly from platform_default; this runner
% never applies a separate capacity factor or parameter override.
...
base.cegrValveMaxArea_m2 = cfg.cegrValveMaxArea_m2;
...
matrix.cegrValveMaxArea_m2 = cfg.cegrValveMaxArea_m2;
