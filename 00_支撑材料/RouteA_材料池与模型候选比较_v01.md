...
本文件只回答“有哪些成熟材料、候选模型和可复用组件”。当前工程化定义见 [RouteA_cEGR_PEMFC_工程化建模规格_v01.md](../04_Simulink物理网络模型/04_说明/RouteA_GasMixture_Derived/RouteA_cEGR_PEMFC_工程化建模规格_v01.md)，实施证据按日期和阶段工作包拆分，入口见 [04_Simulink 工作树 README](../04_Simulink物理网络模型/README.md)。
...
当前判断：Simulink/Simscape 支撑仍然足够，不需要为当前 Route A 引入 AMESim。具体模型规格、接口契约和按阶段拆分的实施证据见 [RouteA_cEGR_PEMFC_工程化建模规格_v01.md](../04_Simulink物理网络模型/04_说明/RouteA_GasMixture_Derived/RouteA_cEGR_PEMFC_工程化建模规格_v01.md) 与 [04_Simulink 工作树 README](../04_Simulink物理网络模型/README.md)。
